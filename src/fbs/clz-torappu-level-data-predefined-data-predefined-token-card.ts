...
export class clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard implements flatbuffers.IUnpackableObject<clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardT> {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsclz_Torappu_LevelData_PredefinedData_PredefinedTokenCard(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard):clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard {
  return (obj || new clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsclz_Torappu_LevelData_PredefinedData_PredefinedTokenCard(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard):clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard {
...
unpack(): clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardT {
  return new clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardT(
    this.initialCnt(),
    this.hidden(),
    this.alias(),
...
unpackTo(_o: clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardT): void {
  _o.initialCnt = this.initialCnt();
...
export class clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardT implements flatbuffers.IGeneratedObject {
constructor(
  public initialCnt: number = 0,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const uniEquipIds = clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.createUniEquipIdsVector(builder, builder.createObjectOffsetList(this.uniEquipIds));
  const masterInfos = clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.createMasterInfosVector(builder, builder.createObjectOffsetList(this.masterInfos));
  ...
  clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.addHidden(builder, this.hidden);
  clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.addAlias(builder, alias);
  clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.addUniEquipIds(builder, uniEquipIds);
  clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.addShowSpIllust(builder, this.showSpIllust);
  clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.addMasterInfos(builder, masterInfos);
  clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.addInst(builder, inst);
  clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.addSkillIndex(builder, this.skillIndex);
  clz_Torappu_LevelData_PredefinedData_PredefinedTokenCard.addMainSkillLvl(builder, this.mainSkillLvl);
