...
export class clz_Torappu_MissionData implements flatbuffers.IUnpackableObject<clz_Torappu_MissionDataT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):clz_Torappu_MissionData {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsclz_Torappu_MissionData(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_MissionData):clz_Torappu_MissionData {
  return (obj || new clz_Torappu_MissionData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsclz_Torappu_MissionData(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_MissionData):clz_Torappu_MissionData {
...
static startclz_Torappu_MissionData(builder:flatbuffers.Builder) {
...
static addItemBgType(builder:flatbuffers.Builder, itemBgType:enum__Torappu_MissionItemBgType) {
  builder.addFieldInt32(4, itemBgType, enum__Torappu_MissionItemBgType.COMMON);
}

static addPreMissionIds(builder:flatbuffers.Builder, preMissionIdsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(5, preMissionIdsOffset, 0);
}
...
static addTemplateType(builder:flatbuffers.Builder, templateTypeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(7, templateTypeOffset, 0);
}

static addParam(builder:flatbuffers.Builder, paramOffset:flatbuffers.Offset) {
  builder.addFieldOffset(8, paramOffset, 0);
}
...
static addUnlockCondition(builder:flatbuffers.Builder, unlockConditionOffset:flatbuffers.Offset) {
  builder.addFieldOffset(9, unlockConditionOffset, 0);
}

static addUnlockParam(builder:flatbuffers.Builder, unlockParamOffset:flatbuffers.Offset) {
  builder.addFieldOffset(10, unlockParamOffset, 0);
}
...
static addToPage(builder:flatbuffers.Builder, toPageOffset:flatbuffers.Offset) {
  builder.addFieldOffset(12, toPageOffset, 0);
}

static addPeriodicalPoint(builder:flatbuffers.Builder, periodicalPoint:number) {
  builder.addFieldInt32(13, periodicalPoint, 0);
}
...
static addBackImagePath(builder:flatbuffers.Builder, backImagePathOffset:flatbuffers.Offset) {
  builder.addFieldOffset(15, backImagePathOffset, 0);
}

static addFoldId(builder:flatbuffers.Builder, foldIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(16, foldIdOffset, 0);
}

static addHaveSubMissionToUnlock(builder:flatbuffers.Builder, haveSubMissionToUnlock:boolean) {
  builder.addFieldInt8(17, +haveSubMissionToUnlock, +false);
}

static addCountEndTs(builder:flatbuffers.Builder, countEndTs:bigint) {
  builder.addFieldInt64(18, countEndTs, BigInt('0'));
}

static endclz_Torappu_MissionData(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createclz_Torappu_MissionData(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, sortId:number, descriptionOffset:flatbuffers.Offset, type:enum__Torappu_MissionType, itemBgType:enum__Torappu_MissionItemBgType, preMissionIdsOffset:flatbuffers.Offset, templateOffset:flatbuffers.Offset, templateTypeOffset:flatbuffers.Offset, paramOffset:flatbuffers.Offset, unlockConditionOffset:flatbuffers.Offset, unlockParamOffset:flatbuffers.Offset, missionGroupOffset:flatbuffers.Offset, toPageOffset:flatbuffers.Offset, periodicalPoint:number, rewardsOffset:flatbuffers.Offset, backImagePathOffset:flatbuffers.Offset, foldIdOffset:flatbuffers.Offset, haveSubMissionToUnlock:boolean, countEndTs:bigint):flatbuffers.Offset {
  clz_Torappu_MissionData.startclz_Torappu_MissionData(builder);
  clz_Torappu_MissionData.addId(builder, idOffset);
  clz_Torappu_MissionData.addSortId(builder, sortId);
  clz_Torappu_MissionData.addDescription(builder, descriptionOffset);
  clz_Torappu_MissionData.addType(builder, type);
  clz_Torappu_MissionData.addItemBgType(builder, itemBgType);
  clz_Torappu_MissionData.addPreMissionIds(builder, preMissionIdsOffset);
  clz_Torappu_MissionData.addTemplate(builder, templateOffset);
  clz_Torappu_MissionData.addTemplateType(builder, templateTypeOffset);
  clz_Torappu_MissionData.addParam(builder, paramOffset);
  clz_Torappu_MissionData.addUnlockCondition(builder, unlockConditionOffset);
  clz_Torappu_MissionData.addUnlockParam(builder, unlockParamOffset);
  clz_Torappu_MissionData.addMissionGroup(builder, missionGroupOffset);
  clz_Torappu_MissionData.addToPage(builder, toPageOffset);
  clz_Torappu_MissionData.addPeriodicalPoint(builder, periodicalPoint);
  clz_Torappu_MissionData.addRewards(builder, rewardsOffset);
  clz_Torappu_MissionData.addBackImagePath(builder, backImagePathOffset);
  clz_Torappu_MissionData.addFoldId(builder, foldIdOffset);
  clz_Torappu_MissionData.addHaveSubMissionToUnlock(builder, haveSubMissionToUnlock);
  clz_Torappu_MissionData.addCountEndTs(builder, countEndTs);
  return clz_Torappu_MissionData.endclz_Torappu_MissionData(builder);
}

unpack(): clz_Torappu_MissionDataT {
  return new clz_Torappu_MissionDataT(
    this.id(),
    this.sortId(),
    this.description(),
    this.type(),
...
unpackTo(_o: clz_Torappu_MissionDataT): void {
  _o.id = this.id();
...
export class clz_Torappu_MissionDataT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const preMissionIds = clz_Torappu_MissionData.createPreMissionIdsVector(builder, builder.createObjectOffsetList(this.preMissionIds));
  ...
  const param = clz_Torappu_MissionData.createParamVector(builder, builder.createObjectOffsetList(this.param));
  const unlockCondition = (this.unlockCondition !== null ? builder.createString(this.unlockCondition!) : 0);
  const unlockParam = clz_Torappu_MissionData.createUnlockParamVector(builder, builder.createObjectOffsetList(this.unlockParam));
  ...
  const rewards = clz_Torappu_MissionData.createRewardsVector(builder, builder.createObjectOffsetList(this.rewards));
  ...
  return clz_Torappu_MissionData.createclz_Torappu_MissionData(builder,
    id,
    this.sortId,
    description,
    this.type,
