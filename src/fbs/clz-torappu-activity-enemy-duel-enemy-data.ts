...
export class clz_Torappu_ActivityEnemyDuelEnemyData implements flatbuffers.IUnpackableObject<clz_Torappu_ActivityEnemyDuelEnemyDataT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):clz_Torappu_ActivityEnemyDuelEnemyData {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsclz_Torappu_ActivityEnemyDuelEnemyData(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_ActivityEnemyDuelEnemyData):clz_Torappu_ActivityEnemyDuelEnemyData {
  return (obj || new clz_Torappu_ActivityEnemyDuelEnemyData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsclz_Torappu_ActivityEnemyDuelEnemyData(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_ActivityEnemyDuelEnemyData):clz_Torappu_ActivityEnemyDuelEnemyData {
