...
import { enum__Torappu_SandboxDevelopmentType } from './enum--torappu-sandbox-development-type.js';
...
techType():enum__Torappu_SandboxDevelopmentType {
  const offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? this.bb!.readInt32(this.bb_pos + offset) : enum__Torappu_SandboxDevelopmentType.NONE;
}
...
static addTechType(builder:flatbuffers.Builder, techType:enum__Torappu_SandboxDevelopmentType) {
  builder.addFieldInt32(1, techType, enum__Torappu_SandboxDevelopmentType.NONE);
}
...
static createclz_Torappu_SandboxDevelopmentData(builder:flatbuffers.Builder, techIdOffset:flatbuffers.Offset, techType:enum__Torappu_SandboxDevelopmentType, positionX:number, positionY:number, frontNodeIdOffset:flatbuffers.Offset, nextNodeIdsOffset:flatbuffers.Offset, limitBaseLevel:number, tokenCost:number, techNameOffset:flatbuffers.Offset, techIconIdOffset:flatbuffers.Offset, nodeTitleOffset:flatbuffers.Offset, rawDescOffset:flatbuffers.Offset, canBuffReserch:boolean):flatbuffers.Offset {
  clz_Torappu_SandboxDevelopmentData.startclz_Torappu_SandboxDevelopmentData(builder);
  clz_Torappu_SandboxDevelopmentData.addTechId(builder, techIdOffset);
  clz_Torappu_SandboxDevelopmentData.addTechType(builder, techType);
  ...
  clz_Torappu_SandboxDevelopmentData.addLimitBaseLevel(builder, limitBaseLevel);
  clz_Torappu_SandboxDevelopmentData.addTokenCost(builder, tokenCost);
  clz_Torappu_SandboxDevelopmentData.addTechName(builder, techNameOffset);
  clz_Torappu_SandboxDevelopmentData.addTechIconId(builder, techIconIdOffset);
  clz_Torappu_SandboxDevelopmentData.addNodeTitle(builder, nodeTitleOffset);
  clz_Torappu_SandboxDevelopmentData.addRawDesc(builder, rawDescOffset);
  clz_Torappu_SandboxDevelopmentData.addCanBuffReserch(builder, canBuffReserch);
...
constructor(
  ...
  public techType: enum__Torappu_SandboxDevelopmentType = enum__Torappu_SandboxDevelopmentType.NONE,
