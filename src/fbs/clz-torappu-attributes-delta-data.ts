...
export class clz_Torappu_AttributesDeltaData implements flatbuffers.IUnpackableObject<clz_Torappu_AttributesDeltaDataT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):clz_Torappu_AttributesDeltaData {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsclz_Torappu_AttributesDeltaData(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_AttributesDeltaData):clz_Torappu_AttributesDeltaData {
  return (obj || new clz_Torappu_AttributesDeltaData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsclz_Torappu_AttributesDeltaData(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_AttributesDeltaData):clz_Torappu_AttributesDeltaData {
...
static startclz_Torappu_AttributesDeltaData(builder:flatbuffers.Builder) {
...
static endclz_Torappu_AttributesDeltaData(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createclz_Torappu_AttributesDeltaData(builder:flatbuffers.Builder, maxHp:number, atk:number, def:number, magicResistance:number, cost:number, blockCnt:number, moveSpeed:number, attackSpeed:number, baseAttackTime:number, respawnTime:number, hpRecoveryPerSec:number, spRecoveryPerSec:number, maxDeployCount:number, maxDeckStackCnt:number, tauntLevel:number, massLevel:number, baseForceLevel:number, stunImmune:boolean, silenceImmune:boolean, sleepImmune:boolean, frozenImmune:boolean, levitateImmune:boolean, disarmedCombatImmune:boolean, fearedImmune:boolean, palsyImmune:boolean, attractImmune:boolean, teleportImmune:boolean):flatbuffers.Offset {
  clz_Torappu_AttributesDeltaData.startclz_Torappu_AttributesDeltaData(builder);
  clz_Torappu_AttributesDeltaData.addMaxHp(builder, maxHp);
  clz_Torappu_AttributesDeltaData.addAtk(builder, atk);
  clz_Torappu_AttributesDeltaData.addDef(builder, def);
  clz_Torappu_AttributesDeltaData.addMagicResistance(builder, magicResistance);
  clz_Torappu_AttributesDeltaData.addCost(builder, cost);
  clz_Torappu_AttributesDeltaData.addBlockCnt(builder, blockCnt);
  clz_Torappu_AttributesDeltaData.addMoveSpeed(builder, moveSpeed);
  clz_Torappu_AttributesDeltaData.addAttackSpeed(builder, attackSpeed);
  clz_Torappu_AttributesDeltaData.addBaseAttackTime(builder, baseAttackTime);
  clz_Torappu_AttributesDeltaData.addRespawnTime(builder, respawnTime);
  clz_Torappu_AttributesDeltaData.addHpRecoveryPerSec(builder, hpRecoveryPerSec);
  clz_Torappu_AttributesDeltaData.addSpRecoveryPerSec(builder, spRecoveryPerSec);
  clz_Torappu_AttributesDeltaData.addMaxDeployCount(builder, maxDeployCount);
  clz_Torappu_AttributesDeltaData.addMaxDeckStackCnt(builder, maxDeckStackCnt);
  clz_Torappu_AttributesDeltaData.addTauntLevel(builder, tauntLevel);
  clz_Torappu_AttributesDeltaData.addMassLevel(builder, massLevel);
  clz_Torappu_AttributesDeltaData.addBaseForceLevel(builder, baseForceLevel);
  clz_Torappu_AttributesDeltaData.addStunImmune(builder, stunImmune);
  clz_Torappu_AttributesDeltaData.addSilenceImmune(builder, silenceImmune);
  clz_Torappu_AttributesDeltaData.addSleepImmune(builder, sleepImmune);
  clz_Torappu_AttributesDeltaData.addFrozenImmune(builder, frozenImmune);
  clz_Torappu_AttributesDeltaData.addLevitateImmune(builder, levitateImmune);
  clz_Torappu_AttributesDeltaData.addDisarmedCombatImmune(builder, disarmedCombatImmune);
  clz_Torappu_AttributesDeltaData.addFearedImmune(builder, fearedImmune);
  clz_Torappu_AttributesDeltaData.addPalsyImmune(builder, palsyImmune);
  clz_Torappu_AttributesDeltaData.addAttractImmune(builder, attractImmune);
  clz_Torappu_AttributesDeltaData.addTeleportImmune(builder, teleportImmune);
  return clz_Torappu_AttributesDeltaData.endclz_Torappu_AttributesDeltaData(builder);
}

unpack(): clz_Torappu_AttributesDeltaDataT {
  return new clz_Torappu_AttributesDeltaDataT(
    this.maxHp(),
    this.atk(),
    this.def(),
...
unpackTo(_o: clz_Torappu_AttributesDeltaDataT): void {
  _o.maxHp = this.maxHp();
  _o.atk = this.atk();
  _o.def = this.def();
...
export class clz_Torappu_AttributesDeltaDataT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return clz_Torappu_AttributesDeltaData.createclz_Torappu_AttributesDeltaData(builder,
    this.maxHp,
    this.atk,
    this.def,
    this.magicResistance,
