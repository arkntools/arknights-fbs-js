...
export class clz_Torappu_ClimbTowerMissionData implements flatbuffers.IUnpackableObject<clz_Torappu_ClimbTowerMissionDataT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):clz_Torappu_ClimbTowerMissionData {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsclz_Torappu_ClimbTowerMissionData(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_ClimbTowerMissionData):clz_Torappu_ClimbTowerMissionData {
  return (obj || new clz_Torappu_ClimbTowerMissionData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsclz_Torappu_ClimbTowerMissionData(bb:flatbuffers.ByteBuffer, obj?:clz_Torappu_ClimbTowerMissionData):clz_Torappu_ClimbTowerMissionData {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new clz_Torappu_ClimbTowerMissionData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

bindGodCardId():string|null
bindGodCardId(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
bindGodCardId(optionalEncoding?:any):string|Uint8Array|null {
  const offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? this.bb!.__string(this.bb_pos + offset, optionalEncoding) : null;
}

bindTowerId():string|null
bindTowerId(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
bindTowerId(optionalEncoding?:any):string|Uint8Array|null {
...
static startclz_Torappu_ClimbTowerMissionData(builder:flatbuffers.Builder) {
  builder.startObject(21);
}

static addBindGodCardId(builder:flatbuffers.Builder, bindGodCardIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(0, bindGodCardIdOffset, 0);
}

static addBindTowerId(builder:flatbuffers.Builder, bindTowerIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(1, bindTowerIdOffset, 0);
}
...
static addItemBgType(builder:flatbuffers.Builder, itemBgType:enum__Torappu_MissionItemBgType) {
  builder.addFieldInt32(6, itemBgType, enum__Torappu_MissionItemBgType.COMMON);
}

static addPreMissionIds(builder:flatbuffers.Builder, preMissionIdsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(7, preMissionIdsOffset, 0);
}
...
static addUnlockCondition(builder:flatbuffers.Builder, unlockConditionOffset:flatbuffers.Offset) {
  builder.addFieldOffset(11, unlockConditionOffset, 0);
}

static addUnlockParam(builder:flatbuffers.Builder, unlockParamOffset:flatbuffers.Offset) {
  builder.addFieldOffset(12, unlockParamOffset, 0);
}
...
static addBackImagePath(builder:flatbuffers.Builder, backImagePathOffset:flatbuffers.Offset) {
  builder.addFieldOffset(17, backImagePathOffset, 0);
}

static addFoldId(builder:flatbuffers.Builder, foldIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(18, foldIdOffset, 0);
}

static addHaveSubMissionToUnlock(builder:flatbuffers.Builder, haveSubMissionToUnlock:boolean) {
  builder.addFieldInt8(19, +haveSubMissionToUnlock, +false);
}

static addCountEndTs(builder:flatbuffers.Builder, countEndTs:bigint) {
  builder.addFieldInt64(20, countEndTs, BigInt('0'));
}

static endclz_Torappu_ClimbTowerMissionData(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createclz_Torappu_ClimbTowerMissionData(builder:flatbuffers.Builder, bindGodCardIdOffset:flatbuffers.Offset, bindTowerIdOffset:flatbuffers.Offset, idOffset:flatbuffers.Offset, sortId:number, descriptionOffset:flatbuffers.Offset, type:enum__Torappu_MissionType, itemBgType:enum__Torappu_MissionItemBgType, preMissionIdsOffset:flatbuffers.Offset, templateOffset:flatbuffers.Offset, templateTypeOffset:flatbuffers.Offset, paramOffset:flatbuffers.Offset, unlockConditionOffset:flatbuffers.Offset, unlockParamOffset:flatbuffers.Offset, missionGroupOffset:flatbuffers.Offset, toPageOffset:flatbuffers.Offset, periodicalPoint:number, rewardsOffset:flatbuffers.Offset, backImagePathOffset:flatbuffers.Offset, foldIdOffset:flatbuffers.Offset, haveSubMissionToUnlock:boolean, countEndTs:bigint):flatbuffers.Offset {
  clz_Torappu_ClimbTowerMissionData.startclz_Torappu_ClimbTowerMissionData(builder);
  clz_Torappu_ClimbTowerMissionData.addBindGodCardId(builder, bindGodCardIdOffset);
  clz_Torappu_ClimbTowerMissionData.addBindTowerId(builder, bindTowerIdOffset);
  clz_Torappu_ClimbTowerMissionData.addId(builder, idOffset);
  clz_Torappu_ClimbTowerMissionData.addSortId(builder, sortId);
  clz_Torappu_ClimbTowerMissionData.addDescription(builder, descriptionOffset);
  clz_Torappu_ClimbTowerMissionData.addType(builder, type);
  clz_Torappu_ClimbTowerMissionData.addItemBgType(builder, itemBgType);
  clz_Torappu_ClimbTowerMissionData.addPreMissionIds(builder, preMissionIdsOffset);
  clz_Torappu_ClimbTowerMissionData.addTemplate(builder, templateOffset);
  clz_Torappu_ClimbTowerMissionData.addTemplateType(builder, templateTypeOffset);
  clz_Torappu_ClimbTowerMissionData.addParam(builder, paramOffset);
  clz_Torappu_ClimbTowerMissionData.addUnlockCondition(builder, unlockConditionOffset);
  clz_Torappu_ClimbTowerMissionData.addUnlockParam(builder, unlockParamOffset);
  clz_Torappu_ClimbTowerMissionData.addMissionGroup(builder, missionGroupOffset);
  clz_Torappu_ClimbTowerMissionData.addToPage(builder, toPageOffset);
  clz_Torappu_ClimbTowerMissionData.addPeriodicalPoint(builder, periodicalPoint);
  clz_Torappu_ClimbTowerMissionData.addRewards(builder, rewardsOffset);
  clz_Torappu_ClimbTowerMissionData.addBackImagePath(builder, backImagePathOffset);
  clz_Torappu_ClimbTowerMissionData.addFoldId(builder, foldIdOffset);
  clz_Torappu_ClimbTowerMissionData.addHaveSubMissionToUnlock(builder, haveSubMissionToUnlock);
  clz_Torappu_ClimbTowerMissionData.addCountEndTs(builder, countEndTs);
  return clz_Torappu_ClimbTowerMissionData.endclz_Torappu_ClimbTowerMissionData(builder);
}

unpack(): clz_Torappu_ClimbTowerMissionDataT {
  return new clz_Torappu_ClimbTowerMissionDataT(
    this.bindGodCardId(),
    this.bindTowerId(),
    this.id(),
    this.sortId(),
...
unpackTo(_o: clz_Torappu_ClimbTowerMissionDataT): void {
  _o.bindGodCardId = this.bindGodCardId();
  _o.bindTowerId = this.bindTowerId();
  _o.id = this.id();
...
export class clz_Torappu_ClimbTowerMissionDataT implements flatbuffers.IGeneratedObject {
constructor(
  public bindGodCardId: string|Uint8Array|null = null,
  public bindTowerId: string|Uint8Array|null = null,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const bindGodCardId = (this.bindGodCardId !== null ? builder.createString(this.bindGodCardId!) : 0);
  const bindTowerId = (this.bindTowerId !== null ? builder.createString(this.bindTowerId!) : 0);
  const id = (this.id !== null ? builder.createString(this.id!) : 0);
  const description = (this.description !== null ? builder.createString(this.description!) : 0);
  const preMissionIds = clz_Torappu_ClimbTowerMissionData.createPreMissionIdsVector(builder, builder.createObjectOffsetList(this.preMissionIds));
  ...
  const param = clz_Torappu_ClimbTowerMissionData.createParamVector(builder, builder.createObjectOffsetList(this.param));
  const unlockCondition = (this.unlockCondition !== null ? builder.createString(this.unlockCondition!) : 0);
  const unlockParam = clz_Torappu_ClimbTowerMissionData.createUnlockParamVector(builder, builder.createObjectOffsetList(this.unlockParam));
  ...
  const rewards = clz_Torappu_ClimbTowerMissionData.createRewardsVector(builder, builder.createObjectOffsetList(this.rewards));
  ...
  return clz_Torappu_ClimbTowerMissionData.createclz_Torappu_ClimbTowerMissionData(builder,
    bindGodCardId,
    bindTowerId,
    id,
    this.sortId,
